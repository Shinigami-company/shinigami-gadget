...
import { SETT_CMD_GIFT, sett_emoji_chocolate_tip, sett_emoji_gift_claim, sett_emoji_items, sett_options_gift_apples, Settings } from "./sett";
...
import { cmd_chocolate } from "./cmd/chocolate.ts";
...
const commands_structure = {
  ...
  chocolate: {
    ...
    register: {
      name: "chocolate",
      description: "See funny credits messages and give support to run the Shinigami",
    },
    atr: {
      defered: deferedActionType.WAIT_MESSAGE,
      //ephemeral: true,
...
export async function cmd_kira_execute(data) {
  ...
  //kill
    ...
    // ! victim lifesteal set in set life()
    //victimInterface.lifesteal = null;
    //await victimInterface.save();
